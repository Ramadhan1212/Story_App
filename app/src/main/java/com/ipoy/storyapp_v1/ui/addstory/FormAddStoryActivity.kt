package com.ipoy.storyapp_v1.ui.addstory
...
class FormAddStoryActivity : AppCompatActivity() {
    ...
    private fun startGallery() {
        ...
        intent.type = "image/*"
        val chooser = Intent.createChooser(intent, applicationContext.getString(R.string.choose_a_picture))
    ...
    private fun uploadImage(token: String) {
        if(binding.etDescription.text.isEmpty()) {
            Toast.makeText(this, applicationContext.getString(R.string.description_should_be_not_empty), Toast.LENGTH_SHORT).show()
            return
        }
        if (getFile != null) {
            ...
            service.enqueue(object : Callback<UserRegisterResponse> {
                ...
                override fun onFailure(call: Call<UserRegisterResponse>, t: Throwable) {
                    Toast.makeText(this@FormAddStoryActivity, applicationContext.getString(R.string.failed_request), Toast.LENGTH_SHORT).show()
                }
            })
        } else {
            Toast.makeText(this@FormAddStoryActivity, applicationContext.getString(R.string.insert_picture_first), Toast.LENGTH_SHORT).show()
        }
    }
}